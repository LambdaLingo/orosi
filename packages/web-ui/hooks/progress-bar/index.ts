import type { DOMAttributes, AriaProgressBarProps } from "types";
import { useLabel } from "hooks/label";
import { useNumberFormatter } from "hooks/i18n";
import { clamp, filterDOMProps, mergeProps } from "utilities";

export type ProgressBarAria = {
